        ...
        <div class="row s_product_inner">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <ul class="list">
                        <c:choose>
                            <c:when test="${itemForm.currentPrice eq itemForm.loggedUserBidValue}">
                                <li><a>Congrats! You are the highest bidder!</a></li>
                            </c:when>
                            <c:when test="${itemForm.loggedUserBidValue eq 0}">
                                <li><a>You did not place any bids for this item</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a><span>Your bid</span>: $${itemForm.loggedUserBidValue}</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <form:form method="POST" action="/account/item/${itemForm.id}"
